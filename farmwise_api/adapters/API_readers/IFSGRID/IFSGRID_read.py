import pandas as pd
from farmwise_api.adapters.API_readers.IFSGRID.utils.extraction import stack_values
from farmwise_api.adapters.API_readers.IFSGRID.utils.preparation import (
    check_overlap,
    build_bbox,
    aggregate_spatial,
    expand_time_dimension
)
from farmwise_api.adapters.API_readers.IFSGRID.mappings.IFSGRID_mappings import GLOBAL_MAPPING
...
async def read_data(
    ...
    aggregated_df = aggregate_spatial(
        factors_data,
        spatial_range,
        level,
        data_range,
