...
from farmwise_api.adapters.API_readers.correctiv.utils.extractors import (
    spatial_extraction,
    time_extraction,
    cols_extraction,
    time_extraction_wide
)
from farmwise_api.adapters.API_readers.correctiv.utils.preparation import data_melting
from farmwise_api.adapters.API_readers.correctiv.mappings.correctiv_mappings import GLOBAL_MAPPING
...
async def read_data(
    ...
    DATA_PATH = adapter_data("correctiv", "data", "data_points.parquet")
