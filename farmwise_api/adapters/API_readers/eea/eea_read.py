...
from farmwise_api.adapters.API_readers.eea.eea_mappings.eea_mappings import GLOBAL_MAPPING
...
async def read_data(
    ...
    final_df = df_expanded.pivot(index="Timestamp", columns="S2CELL")
