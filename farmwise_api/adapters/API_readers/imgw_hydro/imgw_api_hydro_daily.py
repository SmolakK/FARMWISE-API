...
from farmwise_api.core.utils.imgw_utils import create_timestamp_from_row, get_years_between_dates
...
async def read_data(spatial_range, time_range, data_range, level,
    ...
    coors = await asyncio.to_thread(
        pd.read_csv,
        adapter_data("imgw_hydro", "constants", "imgw_coordinates.csv"),
    )
