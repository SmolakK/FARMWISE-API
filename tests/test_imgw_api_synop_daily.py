...
import pandas as pd
from farmwise_api.adapters.API_readers.imgw.imgw_api_synop_daily import read_data
from io import BytesIO
import zipfile


@pytest.mark.asyncio
@patch("farmwise_api.adapters.API_readers.imgw.imgw_api_synop_daily.prepare_coordinates")
@patch("farmwise_api.adapters.API_readers.imgw.imgw_api_synop_daily.httpx.AsyncClient")
@patch("farmwise_api.adapters.API_readers.imgw.imgw_api_synop_daily.pd.read_csv")
async def test_read_data(
    ...
    monkeypatch.setattr(
        "farmwise_api.adapters.API_readers.imgw.imgw_api_synop_daily.adapter_data",
