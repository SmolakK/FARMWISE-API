...
import numpy as np
import pandas as pd
from farmwise_api.adapters.API_readers.corine.corine_read import read_data


@pytest.mark.asyncio
@patch("farmwise_api.adapters.API_readers.corine.corine_read.asyncio.to_thread")
@patch("farmwise_api.adapters.API_readers.corine.corine_read.Image.open")
@patch("farmwise_api.adapters.API_readers.corine.corine_read.prepare_coordinates")
