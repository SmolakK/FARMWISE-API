...
from farmwise_api.server.db_users import add_user, delete_user  # Adjust import paths based on your project structure
...
def test_add_user(db_session, monkeypatch):
    ...
    """
    monkeypatch.setattr("farmwise_api.server.db_users.SessionLocal", lambda: db_session)
