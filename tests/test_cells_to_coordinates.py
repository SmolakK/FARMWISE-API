...
from farmwise_api.core.utils.cells_to_coordinates import s2cells_to_coordinates, _s2cell_id_to_coordinate
import s2sphere
...
@patch("farmwise_api.core.utils.cells_to_coordinates._s2cell_id_to_coordinate")
