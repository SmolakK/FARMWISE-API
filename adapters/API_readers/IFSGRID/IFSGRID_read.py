import pandas as pd
from adapters.API_readers.IFSGRID.utils.extraction import stack_values
from adapters.API_readers.IFSGRID.utils.preparation import (
    check_overlap,
    build_bbox,
    aggregate_spatial,
    expand_time_dimension
)
from adapters.API_readers.IFSGRID.mappings.IFSGRID_mappings import GLOBAL_MAPPING
