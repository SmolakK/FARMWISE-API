...
from adapters.API_readers.correctiv.utils.extractors import (
    spatial_extraction,
    time_extraction,
    cols_extraction,
    time_extraction_wide
)
from adapters.API_readers.correctiv.utils.preparation import data_melting
from adapters.API_readers.correctiv.mappings.correctiv_mappings import GLOBAL_MAPPING
