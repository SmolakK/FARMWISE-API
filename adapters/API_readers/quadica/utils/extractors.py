...
from adapters.API_readers.quadica.mappings.quadica_mappings import DATA_ALIASES
from adapters.API_readers.quadica.utils.definition import DATA_FRAME, DATA_RANGES
