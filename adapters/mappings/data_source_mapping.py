...
# - NName
API_PATH_RANGES = {
    'adapters.API_readers.geosphere.geosphere': (
        ((49.0, 46.0, 17.2, 9.5),
    ...
    'adapters.API_readers.wetterdienst.wetterdienst_dwd': (
    ...
    'adapters.API_readers.soilgrids.soilgrids_call': (  # 11 datasets
        ((71, 34, 45, -25),
    ...
    'adapters.API_readers.cds.cds_single_levels': (
        ((71, 34, 45, -25),
    ...
    'adapters.API_readers.gios.gios_scraper': (
        ((54.8396, 49.0023, 24.1453, 14.1226),
    ...
    'adapters.API_readers.corine.corine_read': (  # 6 datasets
        ((71, 34, 45, -25),
    ...
    'adapters.API_readers.hubeau.hubeau_piezo_read_vbrgm': (
        ((51.09, 41.33, 9.56, -5.14),
         ('1950-01-01', CURRENT_DAY),
    ...
    # 'adapters.API_readers.CHMI_Meteo.CHMI_meteo': (
    ...
    #      1)
    # ),
    'adapters.API_readers.UA_sw_quality.ukrainian_surface_water': (
    ...
    'adapters.API_readers.epa_ireland.epa_gw': (
    ...
    'adapters.API_readers.EuroCropV2.EuroCropV2_read': (
        ((80, -21.7, 55.97, -61.95),
    ...
    'adapters.API_readers.eea.eea_read': (
        ((73, 24, 73, -56),
